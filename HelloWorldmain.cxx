        ...
        char** argv)
{
    ...
    int domain_id = 0;
    std::shared_ptr<HelloWorldApplication> app;
    ...
    else
    {
        try
        {
            app = HelloWorldApplication::make_app(domain_id, argv[1]);
        }
        ...
        std::thread thread(&HelloWorldApplication::run, app);
